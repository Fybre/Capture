...
public class DefaultValueTemplateEvaluatorTests
{
    ...
    [Fact]
    public void Page_number_and_page_count_are_available()
    {
        var context = new DefaultValueContext { PageNumber = 3, PageCount = 17 };

        Assert.Equal("3 of 17", DefaultValueTemplateEvaluator.Evaluate("{Page#} of {PageCount}", context));
    }
