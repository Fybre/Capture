...
public sealed class ProfileExportRunner
{
    ...
    public async Task<IReadOnlyList<ExportResult>> RunAsync(
        DocumentTypeDefinition profile,
        CaptureDocument document,
        IReadOnlyList<IndexValue> indexValues,
        IReadOnlyList<IndexField>? batchFields = null,
    ...
    private async Task RunScriptsAsync(DocumentTypeDefinition profile, CaptureDocument document, List<IndexValue> values, ScriptTrigger trigger, CancellationToken cancellationToken)
    {
