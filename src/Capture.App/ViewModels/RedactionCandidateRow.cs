...
public sealed partial class RedactionCandidateRow : ObservableObject
{
    ...
    /// <summary>Detected and manual rectangles are reviewer-adjustable. A Sensitive-field rectangle
    /// remains tied to that field's extracted bounds rather than silently diverging from it.</summary>
    public bool CanAdjustBounds => Candidate.Source is RedactionSource.Presidio or RedactionSource.Manual;
