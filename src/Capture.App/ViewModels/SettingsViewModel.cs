...
public partial class SettingsViewModel : ViewModelBase
{
    ...
    public SettingsViewModel(
        ...
        ICaptureProfileStore captureProfiles,
    ...
    public IReadOnlyList<InboxOrder> InboxOrderOptions { get; } = Enum.GetValues<InboxOrder>();
    ...
    [ObservableProperty]
    private InboxOrder _inboxOrder = InboxOrder.NewestFirst;
    ...
    public async Task InitializeAsync()
    {
        ...
        foreach (var profile in (await _captureProfiles.GetAllAsync()).Where(profile => profile.Enabled))
    ...
    private WatchFolderEntryViewModel WrapEntry(WatchFolderEntry entry)
    {
        ...
        {
            SelectedCaptureProfile = entry.CaptureProfileId is { } id
