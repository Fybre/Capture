...
public sealed record ScriptRunResult(bool Success, string? Value, string? ErrorMessage, TimeSpan Elapsed, float? Confidence = null)
{
    public static ScriptRunResult Ok(string? value, TimeSpan elapsed, float? confidence = null) =>
        new(true, value, null, elapsed, confidence);
