...
public sealed class WatchSettings
{
    ...
    /// <summary>The shared chronological order for Preview's inbox and every profile table.</summary>
    public InboxOrder InboxOrder { get; set; } = InboxOrder.NewestFirst;
    ...
    /// <summary>When true, capture profiles' C# scripts (<see cref="Capture.Core.Profiles.FieldScript"/>
    ...
    /// which Capture Profile produced the document. Distinct from
