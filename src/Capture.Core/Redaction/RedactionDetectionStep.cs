...
/// finds PII via the bundled Presidio sidecar and any document field marked Sensitive, and either queues the
...
public sealed class RedactionDetectionStep : IPostIndexStep
{
    ...
    public Task RunAsync(PostIndexContext context, CancellationToken cancellationToken = default)
    {
        ...
        return DetectAsync(context.Document, context.Pages, context.DocumentIndexValues, context.Profile.Redaction, cancellationToken);
    }
    ...
    public async Task DetectAsync(
        ...
        IReadOnlyList<IndexValue> documentIndexValues,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var value in documentIndexValues)
        {
